...
ATLAS_LABEL = os.getenv('ATLAS_LABEL', 'Work In Progress').strip()
...
NTUPLE_PATH = os.path.join(os.getenv('HIGGSTAUTAU_NTUPLE_DIR'), 'prod_v5_sys')
...
def save_canvas(canvas, directory, name, formats=None):
    ...
    filepath = os.path.join(BASE_DIR, 'plots', name)
