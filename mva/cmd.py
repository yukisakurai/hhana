...
from .categories import CATEGORIES, NORM_CATEGORIES
from .massregions import DEFAULT_LOW_MASS, DEFAULT_HIGH_MASS
from .variables import VARIABLES
from .regions import REGIONS
from .defaults import FAKES_REGION, TARGET_REGION, NORM_CATEGORY
...
def analysis_parser(parser=None):
    ...
    parser.add_argument('--norm-category', choices=NORM_CATEGORIES.keys(),
            default=NORM_CATEGORIES['presel'],
            help='target normalization category')
