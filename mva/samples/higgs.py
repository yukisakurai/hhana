...
class Higgs(MC, Signal):
    ...
    def __init__(self, year,
        ...
        ########### FOR ODD NORMALIZATION #############
        self.signal_z_even_sum = 0
        self.signal_w_even_sum = 0
        self.signal_gg_even_sum = 0
        self.signal_vbf_even_sum = 0
    ...
    def corrections(self, rec):
        if not self.CP_weight:
            return
        arr = rec2array(rec[['cp_odd_weight', 'cp_even_weight']])
        weights = evaluate("x/y", arr)
        return [weights]
